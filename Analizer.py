...
Srednia ocena produktu wyznaczona na podstawie liczby gwiazdek wynosi {average_score:.1f}.
''')
...
plt.tight_layout()
plt.savefig(f'./figures/{product_id}_recommendation.png', bbox_inches = 'tight')
plt.close()
