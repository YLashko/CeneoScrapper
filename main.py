...
respons = requests.get('https://www.ceneo.pl/96219453#tab=reviews')
...
print(opinion_id, author, recommendation, stars, content, pros, cons, purchased, submit_date, purchase_date, useful, useless, sep='\n')